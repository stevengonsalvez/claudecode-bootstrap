...
name: retro-pdf
version: 1.0.0
description: Convert markdown documents to professional, retro LaTeX-style PDFs with academic formatting, clickable TOC, and proper citations.
license: Apache-2.0
...
metadata:
  ...
  keywords: [pdf, latex, academic, documentation, markdown, typography]

compatibility: Requires Google Chrome (headless mode) for PDF generation
